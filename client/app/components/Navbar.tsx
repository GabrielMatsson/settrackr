...
export default function Navbar() {
  ...
  return (
    <>
    <nav className="bg-gray-50 dark:bg-gray-900 border-r border-gray-200 dark:border-gray-800 w-56 sticky top-0 h-screen hidden md:flex flex-col px-4 py-6 shrink-0">
    ...
    <div className="md:hidden fixed bottom-0 left-0 right-0 z-40 bg-white dark:bg-gray-900 border-t border-gray-200 dark:border-gray-800 flex justify-around py-2">
      {links.map(({ label, href, icon: Icon }) => (
